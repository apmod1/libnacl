...
class TestHash(unittest.TestCase):
    ...
    def test_hash(self):
        ...
        chash1 = hashing.crypto_hash(msg1)
        chash2 = hashing.crypto_hash(msg2)
        self.assertNotEqual(msg1, chash1)
        self.assertNotEqual(msg2, chash2)
        self.assertNotEqual(chash2, chash1)

        ref256 = sha256(msg1)
        self.assertEqual(ref256.digest_size, crypto_hash_sha256_BYTES)
        self.assertEqual(ref256.digest(), hashing.crypto_hash_sha256(msg1))

        ref512 = sha512(msg1)
        self.assertEqual(ref512.digest_size, crypto_hash_sha512_BYTES)
        self.assertEqual(ref512.digest(), hashing.crypto_hash_sha512(msg1))
