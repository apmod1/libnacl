...
def crypto_verify_16(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 16), (len(string2) >=
                                     16), (not nacl.crypto_verify_16(string1, string2))
    return a & b & c
...
def crypto_verify_32(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 32), (len(string2) >=
                                     32), (not nacl.crypto_verify_32(string1, string2))
    return a & b & c
...
def crypto_verify_64(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 64), (len(string2) >=
                                     64), (not nacl.crypto_verify_64(string1, string2))
    return a & b & c
